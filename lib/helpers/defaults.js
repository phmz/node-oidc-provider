...
const constantEquals = require('./constant_equals');
...
<body>
   ...
   * compareClientSecret
   *
   * description: Function used to compare the provided client secret in the request and the
   * expected client secret. The return value should be:
   *
   * - true if the provided secret is valid
   * - falsy otherwise
   *
   */
  compareClientSecret: function compareClientSecret(ctx, actual, expected) {
